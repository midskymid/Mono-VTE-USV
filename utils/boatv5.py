...
class Boatv5TRT(object):
    """
    description: A Boatv5 class that warps TensorRT ops, preprocess and postprocess ops.
    """
    ...
    def infer_onepic(self, raw_image):
        ...
        # print("1: ", input_image.ravel().shape)
        start = time.time()
        ...
        return image_raw, end - start, result_boxes, result_scores
...
if __name__ == "__main__":
    ...
    # image = cv2.imread("/home/jetson/tensorrtx/yolov5/samples/000.jpg")
    # my_image = image[np.newaxis, :, :, :]
    
    try:
        print('batch size is', boatv5_wrapper.batch_size)
        ...
        thread1 = inferonepicThread(boatv5_wrapper)
